...
// node_modules/.pnpm/registry.npmmirror.com+langchain@0.0.81_axios@1.3.3_cheerio@1.0.0-rc.12/node_modules/langchain/dist/chat_models/openai.js
var import_openai = __toESM(require_dist(), 1);

// node_modules/.pnpm/registry.npmmirror.com+langchain@0.0.81_axios@1.3.3_cheerio@1.0.0-rc.12/node_modules/langchain/dist/chat_models/base.js
var BaseChatModel = class extends BaseLanguageModel {
  ...
  async generate(messages, options, callbacks) {
    ...
    const runManager = await callbackManager_?.handleChatModelStart({ name: this._llmType() }, messages, void 0, void 0, invocationParams);
    try {
...
var ChatOpenAI = class extends BaseChatModel {
  ...
  async _generate(messages, options, runManager) {
    ...
    for (const part of data.choices) {
      const role = part.message?.role ?? void 0;
