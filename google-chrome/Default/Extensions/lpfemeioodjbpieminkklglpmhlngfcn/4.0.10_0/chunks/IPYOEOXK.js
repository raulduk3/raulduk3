...
var require_object_hash = __commonJS({
  "node_modules/.pnpm/registry.npmmirror.com+object-hash@3.0.0/node_modules/object-hash/dist/object_hash.js"(exports, module) {
    !function(e) {
      var t;
...
// node_modules/.pnpm/registry.npmmirror.com+langchain@0.0.81_axios@1.3.3_cheerio@1.0.0-rc.12/node_modules/langchain/dist/llms/openai.js
var import_openai2 = __toESM(require_dist(), 1);

// node_modules/.pnpm/registry.npmmirror.com+langchain@0.0.81_axios@1.3.3_cheerio@1.0.0-rc.12/node_modules/langchain/dist/util/chunk.js
...
// node_modules/.pnpm/registry.npmmirror.com+langchain@0.0.81_axios@1.3.3_cheerio@1.0.0-rc.12/node_modules/langchain/dist/cache/base.js
var import_object_hash = __toESM(require_object_hash(), 1);
var getCacheKey = (...strings) => (0, import_object_hash.default)(strings.join("_"));

// node_modules/.pnpm/registry.npmmirror.com+langchain@0.0.81_axios@1.3.3_cheerio@1.0.0-rc.12/node_modules/langchain/dist/cache/index.js
...
// node_modules/.pnpm/registry.npmmirror.com+langchain@0.0.81_axios@1.3.3_cheerio@1.0.0-rc.12/node_modules/langchain/dist/llms/base.js
var BaseLLM = class extends BaseLanguageModel {
  ...
  async _generateUncached(prompts, options, callbacks) {
    ...
    const runManager = await callbackManager_?.handleLLMStart({ name: this._llmType() }, prompts, void 0, void 0, invocationParams);
    let output;
    try {
  ...
  static async deserialize(data) {
    ...
    const Cls = {
      openai: (await import("./J7WLTUGB.js")).OpenAI
    }[_type];
    if (Cls === void 0) {
...
// node_modules/.pnpm/registry.npmmirror.com+langchain@0.0.81_axios@1.3.3_cheerio@1.0.0-rc.12/node_modules/langchain/dist/llms/openai-chat.js
...
var OpenAIChat = class extends LLM {
  ...
  constructor(fields, configuration) {
    ...
    const apiKey = fields?.openAIApiKey ?? (typeof process !== "undefined" ? (
      // eslint-disable-next-line no-process-env
      process.env?.OPENAI_API_KEY
    ) : void 0);
    const azureApiKey = fields?.azureOpenAIApiKey ?? (typeof process !== "undefined" ? (
      // eslint-disable-next-line no-process-env
    ...
    const azureApiInstanceName = fields?.azureOpenAIApiInstanceName ?? (typeof process !== "undefined" ? (
      // eslint-disable-next-line no-process-env
      process.env?.AZURE_OPENAI_API_INSTANCE_NAME
    ) : void 0);
    const azureApiDeploymentName = fields?.azureOpenAIApiDeploymentName ?? (typeof process !== "undefined" ? (
      // eslint-disable-next-line no-process-env
      process.env?.AZURE_OPENAI_API_DEPLOYMENT_NAME
    ) : void 0);
    const azureApiVersion = fields?.azureOpenAIApiVersion ?? (typeof process !== "undefined" ? (
      // eslint-disable-next-line no-process-env
...
var OpenAI = class extends BaseLLM {
  ...
  constructor(fields, configuration) {
    ...
    const azureApiDeploymentName = (fields?.azureOpenAIApiCompletionsDeploymentName || fields?.azureOpenAIApiDeploymentName) ?? (typeof process !== "undefined" ? (
      // eslint-disable-next-line no-process-env
      process.env?.AZURE_OPENAI_API_COMPLETIONS_DEPLOYMENT_NAME || // eslint-disable-next-line no-process-env
      process.env?.AZURE_OPENAI_API_DEPLOYMENT_NAME
    ) : void 0);
    const azureApiVersion = fields?.azureOpenAIApiVersion ?? (typeof process !== "undefined" ? (
      // eslint-disable-next-line no-process-env
