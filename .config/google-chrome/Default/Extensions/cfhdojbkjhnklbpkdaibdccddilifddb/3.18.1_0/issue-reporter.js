 ...
 */ /* eslint-disable */
(function(){'use strict';const { crypto } = self;
...
var self$4 = {};
try { self$4.WeakMap = WeakMap; }
catch (WeakMap) {
  self$4.WeakMap = (function (id, Object) {    var dP = Object.defineProperty;
...
var WeakMap$1 = self$4.WeakMap;/*! (c) Andrea Giammarchi - ISC */
var self$3 = {};
...
var WeakSet$1 = self$3.WeakSet;const {indexOf: indexOf$1, slice: slice$1} = [];const append = (get, parent, children, start, end, before) => {
...
var CustomEvent$1 = self$2.CustomEvent;/*! (c) Andrea Giammarchi - ISC */
var self$1 = {};
try { self$1.Map = Map; }
catch (Map) {
...
var Map$1 = self$1.Map;function Component() {
  return this;
}
